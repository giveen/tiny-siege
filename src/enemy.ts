...
const ROSTER = [
  ...
  ["abyss_bat_2", "Abyss Bat II", "abyss", 36, 66, 5, 3, 1.3, "f"] as const,
  ["abyss_blueberry", "Abyss Blueberry", "abyss", 18, 74, 3, 2, 1.05, ""] as const,
  ["abyss_cult_leader", "Abyss Cult Leader", "abyss", 70, 46, 8, 5, 1.5, ""] as const,
  ["abyss_drone", "Abyss Drone", "abyss", 22, 72, 3, 2, 1.1, ""] as const,
  ["abyss_druid", "Abyss Druid", "abyss", 50, 50, 7, 4, 1.4, ""] as const,
  ["abyss_fat_gargoyle", "Abyss Fat Gargoyle", "abyss", 60, 52, 7, 5, 1.5, "f a2"] as const,
  ["abyss_goblin", "Abyss Goblin", "abyss", 40, 56, 5, 3, 1.4, ""] as const,
  ["abyss_imp", "Abyss Imp", "abyss", 30, 66, 4, 3, 1.2, "f"] as const,
  ["abyss_lurker", "Abyss Lurker", "abyss", 44, 52, 5, 4, 1.3, ""] as const,
  ["abyss_minion", "Abyss Minion", "abyss", 34, 58, 5, 3, 1.3, ""] as const,
  ["abyss_monster", "Abyss Monster", "abyss", 28, 64, 4, 2, 1.2, ""] as const,
  ["abyss_reaper", "Abyss Reaper", "abyss", 80, 44, 9, 6, 1.5, ""] as const,
  ["abyss_siren_form_1", "Abyss Siren", "abyss", 30, 60, 4, 3, 1.2, ""] as const,
  ["abyss_siren_form_2", "Abyss Siren II", "abyss", 42, 54, 6, 3, 1.3, ""] as const,
  ["abyss_siren_form_3", "Abyss Siren III", "abyss", 100, 46, 10, 6, 1.8, ""] as const,
  ["abyss_slug", "Abyss Slug", "abyss", 48, 34, 6, 4, 1.4, "a2"] as const,
  ["abyss_squid", "Abyss Squid", "abyss", 36, 56, 5, 3, 1.3, ""] as const,
  ["abyss_tiny_slug", "Abyss Tiny Slug", "abyss", 26, 46, 4, 2, 1.2, "a1"] as const,
  // -- blobs -------------------------------------------------------------
  ["green_blob_form_1", "Green Blob", "blobs", 30, 58, 5, 3, 1.2, ""] as const,
  ["happy_blob", "Happy Blob", "blobs", 80, 48, 8, 4, 1.85, ""] as const,
  ["suspicious_blob", "Suspicious Blob", "blobs", 26, 62, 5, 2, 1.2, ""] as const,
  // -- cave ----------------------------------------------------------------
  ...
  // -- clockwork -------------------------------------------------------------
["clockwork_imp", "Clockwork Imp", "clockwork", 34, 58, 5, 3, 1.25, "a1"] as const,
  ["clockwork_soldier", "Clockwork Soldier", "clockwork", 44, 52, 6, 4, 1.3, "a2"] as const,
  ["clockwork_behemoth", "Clockwork Behemoth", "clockwork", 95, 40, 11, 5, 1.7, "a3"] as const,
  // -- dust --------------------------------------------------------------
  ["dust_explosioniate", "Dust Explosioniate", "dust", 36, 56, 5, 3, 1.2, ""] as const,
  ["dust_elemental", "Dust Elemental", "dust", 55, 48, 7, 4, 1.45, "a1"] as const,
  // -- fire --------------------------------------------------------------
  ["fire_imp", "Fire Imp", "fire", 32, 58, 5, 3, 1.2, ""] as const,
  ["fire_elemental", "Fire Elemental", "fire", 44, 50, 7, 4, 1.4, ""] as const,
  // -- forest --------------------------------------------------------------
  ["forest_boss_imp", "Forest Boss Imp", "forest", 240, 48, 18, 12, 1.6, "a2"] as const,
  ["forest_bushling", "Forest Bushling", "forest", 22, 70, 4, 2, 1.1, ""] as const,
  ["forest_girl", "Forest Girl", "forest", 28, 64, 5, 3, 1.2, ""] as const,
  ["forest_healing_imp", "Forest Healing Imp", "forest", 64, 46, 5, 6, 1.3, "h"] as const,
  ["forest_imp", "Forest Imp", "forest", 18, 76, 3, 2, 1.1, ""] as const,
  ["forest_nymph", "Forest Nymph", "forest", 70, 50, 8, 5, 1.75, ""] as const,
  ["forest_spider", "Forest Spider", "forest", 24, 68, 4, 2, 1.2, ""] as const,
  // -- frost ---------------------------------------------------------------
  ["frost_yetling", "Frost Yetling", "frost", 45, 52, 6, 4, 1.3, ""] as const,
  ["frost_ice_buff", "Frost Ice Buff", "frost", 70, 44, 5, 6, 1.4, "h"] as const,
  ["frost_golem", "Frost Golem", "frost", 110, 38, 12, 5, 1.65, "a3"] as const,
  ["frost_gorilla", "Frost Gorilla", "frost", 150, 36, 14, 7, 1.85, "a3"] as const,
  // -- junkyard --------------------------------------------------------------
  ["junkyard_tiny_boxer", "Junkyard Tiny Boxer", "junkyard", 34, 60, 5, 3, 1.2, ""] as const,
  ["junkyard_goblin", "Junkyard Goblin", "junkyard", 40, 56, 5, 3, 1.2, ""] as const,
  ["junkyard_boxer", "Junkyard Boxer", "junkyard", 60, 52, 8, 4, 1.5, "a1"] as const,
  ["junkyard_skeleton", "Junkyard Skeleton", "junkyard", 48, 50, 7, 4, 1.3, ""] as const,
  ["junkyard_golem", "Junkyard Golem", "junkyard", 70, 46, 9, 4, 1.55, "a2"] as const,
  ["junkyard_brute", "Junkyard Brute", "junkyard", 90, 42, 11, 5, 1.6, "a2"] as const,
["junkyard_titan", "Junkyard Titan", "junkyard", 110, 38, 13, 6, 1.7, "a3"] as const,
  ["junkyard_buffed_titan", "Junkyard Buffed Titan", "junkyard", 130, 36, 14, 7, 1.8, "a3"] as const,
  // -- molten --------------------------------------------------------------
  ["molten_golem", "Molten Golem", "molten", 55, 46, 7, 4, 1.45, "a1"] as const,
  ["molten_golem_2", "Molten Golem II", "molten", 75, 42, 9, 5, 1.6, "a2"] as const,
  // -- night ---------------------------------------------------------------
  ["night_imp", "Night Imp", "night", 30, 62, 5, 3, 1.1, ""] as const,
  ["night_healing_imp", "Night Healing Imp", "night", 66, 44, 5, 6, 1.3, "h"] as const,
  // -- phantom ---------------------------------------------------------------
  ["phantom_minitaur", "Phantom Minitaur", "phantom", 55, 52, 7, 4, 1.3, ""] as const,
  ["phantom_mediumtaur", "Phantom Mediumtaur", "phantom", 70, 48, 9, 4, 1.4, ""] as const,
  ["phantom_bull", "Phantom Bull", "phantom", 85, 50, 11, 5, 1.5, "a1"] as const,
  ["phantom_minotaur", "Phantom Minotaur", "phantom", 100, 46, 12, 6, 1.6, "a2"] as const,
  // -- plague ----------------------------------------------------------------
  ["plaguebearer_imp", "Plaguebearer Imp", "plague", 26, 64, 4, 3, 1.1, ""] as const,
  ["plaguebearer_mono_imp", "Plaguebearer Mono Imp", "plague", 24, 66, 4, 3, 1.1, ""] as const,
  ["plaguebearer_handless_imp", "Plaguebearer [REDACTED:Bearer token] Imp", "plague", 30, 60, 5, 3, 1.2, ""] as const,
  ["plaguebearer_dog", "Plaguebearer Dog", "plague", 38, 56, 6, 3, 1.4, ""] as const,
  // -- scavengers (small fast strays) ----------------------------------------
  ["rat", "Rat", "scavengers", 14, 78, 3, 1, 1.1, ""] as const,
  ["tick", "Tick", "scavengers", 16, 64, 3, 1, 1.0, ""] as const,
  ["tiny_spider", "Tiny Spider", "scavengers", 12, 84, 2, 1, 1.0, ""] as const,
  ["lime", "Lime", "scavengers", 13, 80, 2, 1, 1.05, ""] as const,
  ["shadowfiend", "Shadowfiend", "scavengers", 18, 72, 4, 2, 1.25, ""] as const,
  ["large_snake", "Large Snake", "scavengers", 26, 70, 5, 2, 1.3, ""] as const,
  ["sandworm", "Sandworm", "scavengers", 40, 52, 6, 3, 1.6, ""] as const,
  // -- shell (armored shellers) --------------------------------------------
  ["shell_tortoise", "Shell Tortoise", "shell", 60, 34, 9, 4, 1.35, "a3"] as const,
  ["shell_tortoise_form_2", "Shell Tortoise II", "shell", 85, 30, 11, 5, 1.55, "a3"] as const,
  ["shell_tortoise_form_3", "Shell Tortoise III", "shell", 130, 26, 14, 6, 1.95, "a4"] as const,
  ["giant_turtle", "Giant Turtle", "shell", 75, 32, 10, 4, 1.45, "a3"] as const,
  ["stone_slug_1", "Stone Slug", "shell", 65, 30, 9, 4, 1.45, "a3"] as const,
  // -- spectral --------------------------------------------------------------
  ["spectral_hound", "Spectral Hound", "spectral", 34, 66, 5, 3, 1.3, ""] as const,
  ["spectral_hound_2", "Spectral Hound II", "spectral", 38, 64, 5, 3, 1.3, ""] as const,
  ["spectral_harvester_1", "Spectral Harvester", "spectral", 70, 52, 8, 5, 1.6, ""] as const,
  // -- spiders ----------------------------------------------------------------
  ["spiderling_swarm_leader", "Spiderling Swarm Leader", "spiders", 40, 58, 6, 3, 1.3, ""] as const,
  ["giant_spider", "Giant Spider", "spiders", 120, 44, 13, 6, 1.8, "a2"] as const,
  // -- strays (odd one-offs) ---------------------------------------------------
  ["goblin_cutthroat", "Goblin Cutthroat", "strays", 30, 62, 5, 3, 1.2, ""] as const,
  ["mirrorfiend", "Mirrorfiend", "strays", 34, 58, 6, 3, 1.3, ""] as const,
  ["wierd_traveler", "Wierd Traveler", "strays", 38, 55, 6, 3, 1.3, ""] as const,
  // -- toxic (death leaves a poison patch) --------------------------------------
  ["toxic_sludge_small_pile", "Toxic Sludge Small Pile", "toxic", 40, 44, 6, 3, 1.25, "p"] as const,
  ["toxic_sludge_wisp", "Toxic Sludge Wisp", "toxic", 30, 60, 4, 3, 1.1, "p"] as const,
  ["toxic_sludge_slime", "Toxic Sludge Slime", "toxic", 45, 48, 5, 3, 1.3, "p"] as const,
  ["toxic_sludge_skeleton", "Toxic Sludge Skeleton", "toxic", 80, 44, 9, 5, 1.55, "p a2"] as const,
  ["toxic_sludge_pile", "Toxic Sludge Pile", "toxic", 90, 40, 10, 5, 1.6, "p a2"] as const,
  // -- undead (late-run skeletons and reapers) --------------------------------
  ["skeleton", "Skeleton", "undead", 50, 48, 8, 4, 1.35, "a2"] as const,
